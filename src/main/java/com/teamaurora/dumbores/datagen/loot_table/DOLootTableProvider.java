package com.teamaurora.dumbores.datagen.loot_table;
...
public class DOLootTableProvider extends LootTableProvider {
    ...
    public DOLootTableProvider(DataGenerator dataGenerator) {
        super(dataGenerator);
    }
    ...
    protected List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootParameterSet>> getTables() {
        ...
        builder.add(Pair.of(DOBlockLootTables::new, LootParameterSets.BLOCK));
