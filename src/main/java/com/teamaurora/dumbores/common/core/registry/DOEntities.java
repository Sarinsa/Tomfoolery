package com.teamaurora.dumbores.common.core.registry;

import com.teamaurora.dumbores.common.core.DumbOres;
import com.teamaurora.dumbores.common.entity.CactusBlockEntity;
...
public class DOEntities {
    ...
    public static final RegistryObject<EntityType<CactusBlockEntity>> CACTUS_BLOCK_ENTITY = register("cactus_block_entity", EntityType.Builder.<CactusBlockEntity>of(CactusBlockEntity::new, EntityClassification.MISC).noSummon().sized(0.25F, 0.25F).clientTrackingRange(8).updateInterval(5));
