package com.sarinsa.dumb_ores.datagen.loot_table;
...
public class TomBlockLootTables extends BlockLootTables {
    ...
    protected void addTables() {
        ...
        this.add(TomBlocks.ORE_ORE.get(), (block) ->
        ...
        this.add(TomBlocks.CAKE_ORE.get(), (block) ->
                createSilkTouchDispatchTable(block, applyExplosionDecay(block, TagLootEntry.expandTag(TomItemTags.CAKES)
                        .apply(ApplyBonus.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)))));
    }
}
